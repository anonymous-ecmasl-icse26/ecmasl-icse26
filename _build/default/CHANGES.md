...
- Use smtml's cached solver
- Fix integer to string conversions #285

### Added

- Parametrize choice monad to receive solver type
- Add ecma-sl's lsp as a submodule
- Adds 3 object modelling options: `logging`, `lifting` and `loglifting`
...
- Bump smtml 0.6.3 -> 0.7.0

### Fixed

- Revert infinite loop in JSON.stringify
- Fix some symbolic execution summaries (@filipeom, breaking)
