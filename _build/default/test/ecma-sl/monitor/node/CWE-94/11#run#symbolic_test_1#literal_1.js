...
// Vuln: code-injection
var rules = {  };
var options = { ignoreFactChanges: undefined };
var ret_new_module_exports = new module.exports(rules, options);
var o = { condition: undefined, consequence: "console.log('success')" };
var rules = [ o ];
taint.upg_prop(o, "consequence", "H");
taint.set_sink(eval);
ret_new_module_exports.fromJSON(rules);
