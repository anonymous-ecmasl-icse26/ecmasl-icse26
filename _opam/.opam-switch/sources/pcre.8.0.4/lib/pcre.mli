...
(** Perl Compatibility Regular Expressions for OCaml
    ...
    {e 8.0.4 - {{:https://mmottl.github.io/pcre-ocaml} homepage}} *)
...
type error =
  ...
  | RecursionLimit
  | WorkspaceSize
      (** Raised by {!pcre_dfa_exec} when the provided workspace array is too
          small. See documention on {!pcre_dfa_exec} for details on workspace
          array sizing. *)
...
and cflag =
  ...
  | `NO_UTF8_CHECK
    (** Turns off validity checks on UTF8 strings for efficiency reasons.
        WARNING: invalid UTF8 strings may cause a crash then! *)
