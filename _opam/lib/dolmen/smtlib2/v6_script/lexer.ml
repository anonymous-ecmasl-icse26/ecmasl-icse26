# 6 "src/languages/smtlib2/v2.6/script/lexer.mll"
...
# 149 "src/languages/smtlib2/v2.6/script/lexer.ml"
...
and __ocaml_lex_token_rec newline lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 181 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( EOF )
# 411 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 1 ->
# 182 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( token newline lexbuf )
# 416 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 2 ->
# 183 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( newline lexbuf; token newline lexbuf )
# 421 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 3 ->
# 184 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( token newline lexbuf )
# 426 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 4 ->
# 187 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( OPEN )
# 431 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 5 ->
# 188 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( CLOSE )
# 436 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 6 ->
let
# 189 "src/languages/smtlib2/v2.6/script/lexer.mll"
               s
# 442 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 189 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( NUM s )
# 446 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 7 ->
let
# 190 "src/languages/smtlib2/v2.6/script/lexer.mll"
               s
# 452 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 190 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( DEC s )
# 456 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 8 ->
let
# 191 "src/languages/smtlib2/v2.6/script/lexer.mll"
                   s
# 462 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 191 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( HEX s )
# 466 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 9 ->
let
# 192 "src/languages/smtlib2/v2.6/script/lexer.mll"
              s
# 472 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 192 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( BIN s )
# 476 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 10 ->
# 193 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( string newline (Buffer.create 42) lexbuf )
# 481 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 11 ->
let
# 194 "src/languages/smtlib2/v2.6/script/lexer.mll"
               s
# 487 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 194 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( KEYWORD s )
# 491 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 12 ->
let
# 195 "src/languages/smtlib2/v2.6/script/lexer.mll"
                     s
# 497 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 195 "src/languages/smtlib2/v2.6/script/lexer.mll"
                                        ( symbol newline lexbuf s)
# 501 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 13 ->
let
# 196 "src/languages/smtlib2/v2.6/script/lexer.mll"
                                s
# 507 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme lexbuf (lexbuf.Lexing.lex_start_pos + 1) (lexbuf.Lexing.lex_curr_pos + -1) in
# 196 "src/languages/smtlib2/v2.6/script/lexer.mll"
                                        ( quoted_symbol newline lexbuf s )
# 511 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 14 ->
# 197 "src/languages/smtlib2/v2.6/script/lexer.mll"
                                        ( raise Error )
# 516 "src/languages/smtlib2/v2.6/script/lexer.ml"
...
and __ocaml_lex_string_rec newline b lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 200 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( Buffer.add_char b '"'; string newline b lexbuf )
# 528 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 1 ->
# 201 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( STR (Buffer.contents b) )
# 533 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 2 ->
let
# 202 "src/languages/smtlib2/v2.6/script/lexer.mll"
                                           c
# 539 "src/languages/smtlib2/v2.6/script/lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 203 "src/languages/smtlib2/v2.6/script/lexer.mll"
    ( if c = '\n' then newline lexbuf;
      Buffer.add_char b c; string newline b lexbuf )
# 544 "src/languages/smtlib2/v2.6/script/lexer.ml"

  | 3 ->
# 205 "src/languages/smtlib2/v2.6/script/lexer.mll"
                        ( raise Error )
# 549 "src/languages/smtlib2/v2.6/script/lexer.ml"
