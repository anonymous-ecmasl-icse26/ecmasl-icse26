...
module Asttypes = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Asttypes instead"]
...
module Errortrace_report = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Errortrace_report instead"]
...
module Format_doc = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Format_doc instead"]
...
module Gprinttyp = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Gprinttyp instead"]
...
module Linkdeps = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Linkdeps instead"]
...
module Out_type = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Out_type instead"]
...
module Rawprinttyp = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_common.Rawprinttyp instead"]
...
module Stackframe = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Stackframe instead"]
module Stackframegen = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Stackframegen instead"]
...
module Thread_sanitizer = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Thread_sanitizer instead"]
