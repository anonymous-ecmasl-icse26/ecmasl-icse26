...
// remove
var res8 = buckets.arrays.remove(numberArray, n3);
var res9 = buckets.arrays.remove(numberArray, n4);
esl_symbolic.assert(res8);
// esl_symbolic.assert(!res9);
esl_symbolic.assert(esl_symbolic.not(res9));
