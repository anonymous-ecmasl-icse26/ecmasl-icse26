...
const buckets = require("./../../../src/base");

const arrays = require("./../../../src/lib/arrays").arrays
const dictionary = require("./../../../src/lib/dictionary").Dictionary
...
esl_symbolic.assert(
    esl_symbolic.or(
        esl_symbolic.and(
            ...
            esl_symbolic.eq(res, true)
        ),
        esl_symbolic.and(
            esl_symbolic.eq(x1, x2),
            esl_symbolic.eq(res, false)
        )
    )
);
