...
esl_symbolic.assert(
    esl_symbolic.or(
        esl_symbolic.and(esl_symbolic.eq(s1, s2), esl_symbolic.eq(res1, 1)),
        esl_symbolic.and(esl_symbolic.neq(s1, s2), esl_symbolic.eq(res1, 2))
    )
);
...
esl_symbolic.assert(esl_symbolic.not(res3));
