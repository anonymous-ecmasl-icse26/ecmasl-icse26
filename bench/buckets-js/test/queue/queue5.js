...
esl_symbolic.assume(esl_symbolic.and(esl_symbolic.lt(x1, x2), esl_symbolic.lt(x2, x3)));
...
esl_symbolic.assert(esl_symbolic.eq(l1, l3));
...
for (i = 0; i < ar1.length; i++) {
  ...
  esl_symbolic.assert(esl_symbolic.eq(ar1i, ar2i));
}
