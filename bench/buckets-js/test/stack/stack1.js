...
esl_symbolic.assert(esl_symbolic.eq(res1, undefined));
...
esl_symbolic.assert(esl_symbolic.eq(res2, n3));

// esl_symbolic.assert(res6 == n3);
esl_symbolic.assert(esl_symbolic.eq(res6, n3));

// esl_symbolic.assert(res3 == n2);
esl_symbolic.assert(esl_symbolic.eq(res3, n2));

// esl_symbolic.assert(res4 == n1);
esl_symbolic.assert(esl_symbolic.eq(res4, n1));

// esl_symbolic.assert(res5 == undefined);
esl_symbolic.assert(esl_symbolic.eq(res5, undefined));